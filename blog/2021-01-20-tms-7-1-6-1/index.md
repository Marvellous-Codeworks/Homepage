...
Install from the [Chrome Web Store](https://go.gioxx.org/tgs) or [load from source](https://github.com/gioxx/MarvellousSuspender#install-as-an-extension-from-source).
